...
int mul_core(const unsigned char *a, const char *s, int32_t *sum1, int32_t *sum2, unsigned int vec_num)
{
	int i,j;
...
{
	int i;
	int32_t sum1[vec_num],sum2[vec_num];
