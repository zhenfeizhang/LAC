...
// poly_mul  b=as
int mul_core(const unsigned char *a, const char *s, int16_t *sum_one, int16_t *sum_mone, unsigned int vec_num)
{
	int i,j;
	uint8_t  __attribute__((aligned(32))) v[DIM_N*2];
...
{
	int i;
	int16_t  __attribute__((aligned(32))) sum_one[DIM_N],sum_mone[DIM_N];
